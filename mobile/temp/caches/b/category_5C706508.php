<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:64:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:74:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:74:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1446390932;s:8:"maketime";i:1446387332;}<html>
<head>
...
<ul><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">最新</a></li><li class="on"><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=ASC#goods_list" >销量</a></li><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" >更新</a></li><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格<span class="arrow_up "></span><span class="arrow_down "></span></a></li><li class=""><a href="javascript:;" class="show_type  show_list">&nbsp;</a></li></ul>
</section>
<section>
<script type="text/javascript">
var url = 'category.php?act=ajax&category=2&&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC&other_has=0';
$(function(){

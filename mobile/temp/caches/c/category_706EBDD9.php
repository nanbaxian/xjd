<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:64:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:74:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:74:"F:/wwwroot/h/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1446390937;s:8:"maketime";i:1446387337;}<html>
<head>
...
<script type="text/javascript" src="js/jquery.json.js"></script><script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/common.js"></script><script type="application/javascript" src="themesmobile/68ecshopcom_mobile/js/jquery.more.js"></script>
</head>
<body>
<section class="_pre" >
...
<ul><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">最新</a></li><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list" >销量</a></li><li class=""><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" >更新</a></li><li class="on"><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格<span class="arrow_up "></span><span class="arrow_down active_down"></span></a></li><li class=""><a href="javascript:;" class="show_type  show_list">&nbsp;</a></li></ul>
</section>
<section>
<script type="text/javascript">
var url = 'category.php?act=ajax&category=2&&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=DESC&other_has=0';
$(function(){
...
<ul><li class="filtrate_list_li"><a href="category.php?id=2" class="filtrate_list_li_a on" style="padding-left:25px"><span>服装服饰</span></a><ul>
 
<li class="filtrate_list_li"><a href="category.php?id=55" class="filtrate_list_li_a " style="padding-left:45px;">女装馆</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=56" class="filtrate_list_li_a " style="padding-left:45px;">内衣馆</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=57" class="filtrate_list_li_a " style="padding-left:45px;">男装馆</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=58" class="filtrate_list_li_a " style="padding-left:45px;">户外鞋服</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=59" class="filtrate_list_li_a " style="padding-left:45px;">女鞋馆</a></li>
 
<li class="filtrate_list_li"><a href="category.php?id=60" class="filtrate_list_li_a " style="padding-left:45px;">箱包馆</a></li>
...
<li class="on"  id="brand_0"><a href="javascript:get_brand('0')">全部</a></li>
<li   id="brand_48"><a href="javascript:get_brand('48')">楼兰密语</a></li>
<li   id="brand_51"><a href="javascript:get_brand('51')">享爱.</a></li>
<li   id="brand_53"><a href="javascript:get_brand('53')">茵曼（INMAN）</a></li>
<li   id="brand_54"><a href="javascript:get_brand('54')">缪诗</a></li>
<li   id="brand_55"><a href="javascript:get_brand('55')">卓诗尼</a></li>
<li   id="brand_56"><a href="javascript:get_brand('56')">七匹狼</a></li>
<li   id="brand_57"><a href="javascript:get_brand('57')">佐丹奴</a></li>
<li   id="brand_58"><a href="javascript:get_brand('58')">达芙妮</a></li>
<li   id="brand_60"><a href="javascript:get_brand('60')">曼妮芬（ManniForm）</a></li>
<li   id="brand_61"><a href="javascript:get_brand('61')">伊芙丽</a></li>
<li   id="brand_73"><a href="javascript:get_brand('73')">伊莱克斯</a></li>
<li   id="brand_80"><a href="javascript:get_brand('80')">溢彩年华</a></li>
                </ul>
        
                    
        <div class="filtrate_price"onclick="return 1;">
                    价格 <input type="number" id="lp" value="0" name="price_min">∼
                        <input type="number" id="hp" value="0" name="price_max">元
        </div>      
...
<header class="con floatsearch">
   ...
   <section class="mix_recently_search"><h3>热门搜索</h3>
    ...
    <a href="search.php?keywords=%E8%BF%9E%E8%A1%A3%E8%A3%99">连衣裙</a>
      ...
      <li>
    <a href="search.php?keywords=%E6%8A%A4%E8%82%A4">护肤</a>
   </li>
      <li>
    <a href="search.php?keywords=%E5%B0%8F%E7%A2%8E%E8%8A%B1">小碎花</a>
   </li>
      <li>
    <a href="search.php?keywords=%E9%9B%85%E8%AF%97%E5%85%B0%E9%BB%9B">雅诗兰黛</a>
   </li>
      <li>
    <a href="search.php?keywords=%E9%98%BF%E8%BF%AA%E8%BE%BE%E6%96%AF">阿迪达斯</a>
   </li>
      </ul>
        </section>
